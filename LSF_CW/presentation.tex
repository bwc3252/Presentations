...
\frame{ \frametitle{Example}
  PE for GW170817 data with WoKo2017 model on $z$ band:
  \begin{figure}
    \includegraphics[width=2.6in]{Images/GW170817_woko2017.png}
  \end{figure}
}

\frame{ \frametitle{Example}
  PE for GW170817 data with two-component WoKo2017 model on $z$ band:
  \begin{figure}
    \includegraphics[width=2.4in]{Images/GW170817_woko2017_two_comp.png}
  \end{figure}
}

\frame{ \frametitle{Example}
  PE for GW170817 data with two-component Me2017 model on $z$ band:
  \begin{figure}
    \includegraphics[width=2.4in]{Images/GW170817_me2017_mej.png}
  \end{figure}
}
